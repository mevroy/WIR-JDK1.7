	...
	<div class="jumbotron">
		...
		<div>
			...
			<form:form commandName="groupClient" action="groupClient"
				...
				<h3>
					Address <span><a id="address-plus-sign" href="#"
						onclick="replaceHTML('newAddress',$('#addressForm').html()); hideById('address-plus-sign'); showById('address-minus-sign'); $('#groupClient').validate(); $('input#streetAddress').rules('add', 'required'); $('select#addressType').rules('add', 'required');"><i
							class="glyphicon glyphicon-plus-sign"></i></a><a
						style="display: none;" id="address-minus-sign" href="#"
						onclick="replaceHTML('newAddress',''); hideById('address-minus-sign'); showById('address-plus-sign');"><i
							class="glyphicon glyphicon-minus-sign"></i></a></span>
				</h3>

				<div class="row" id="newAddress"></div>
				<h3>
					Contact <span><a id="contact-plus-sign" href="#"
						onclick="replaceHTML('newContact',$('#contactForm').html()); hideById('contact-plus-sign'); showById('contact-minus-sign'); $('#groupClient').validate(); $('input#contactFirstName').rules('add', 'required'); $('select#contactType').rules('add', 'required');"><i
							class="glyphicon glyphicon-plus-sign"></i></a><a
						style="display: none;" href="#" id="contact-minus-sign"
						onclick="replaceHTML('newContact',''); hideById('contact-minus-sign'); showById('contact-plus-sign')"><i
							class="glyphicon glyphicon-minus-sign"></i></a></span>
				</h3>
				<div class="row" id="newContact"></div>
...
<div style="display: none;">
	<form:form commandName="groupClient" action="groupClient" method="post"
		id="addressForm">
		<div class="col-lg-5">
		...
		<div class="col-lg-offset-2 col-lg-5">
			...
			<div class="form-group" id="suburbCtl">
				...
				<div class="controls">
					<form:input path="groupAddress[0].suburb" cssClass="form-control"
						id="suburb" placeholder="Enter Suburb" />
			...
			<div class="form-group" id="zipCodeCtl">
				...
				<div class="controls">
					<form:input path="groupAddress[0].zipCode" cssClass="form-control"
	...
	<form:form commandName="groupClient" action="groupClient" method="post"
		...
		<div class="col-lg-5">
			<div class="form-group" id="contactTypeCtl">
				...
				<div class="controls">
					<form:select path="groupClientContact[0].contactType"
						cssClass="form-control" id="contactType"
						placeholder="Enter Contact Type">
						<form:option value="">Select One</form:option>
						<form:option value="CLIENT" selected="true">CLIENT</form:option>
						<form:option value="SITE">SITE</form:option>
						<form:option value="OTHER">OTHER</form:option>
					</form:select>
				</div>
			...
			<div class="form-group" id="firstNameCtl">
				<label class="control-label" for="firstName">Contact First
					Name</label>
